      ...
      <div className="container relative min-h-screen flex-col items-center justify-center md:grid lg:max-w-none lg:grid-cols-2 lg:px-0">
        ...
        <div className="relative hidden h-full flex-col overflow-hidden p-10 text-white lg:flex dark:border-r">
          <div className="absolute inset-0">
            ...
            <div className="absolute inset-12 rounded-3xl border border-white/10 bg-white/5 backdrop-blur-sm" />
          </div>
          <div className="relative z-20 flex items-center text-lg font-medium">
            <div className="mr-3 flex h-10 w-10 items-center justify-center rounded-xl border border-white/10 bg-black/20 p-2 backdrop-blur">
              <Image src="/logo.png" alt="Nivafy" width={28} height={28} priority />
            </div>
            <span className="text-2xl font-semibold tracking-tight">Nivafy</span>
          </div>
